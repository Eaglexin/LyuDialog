...
import polly.com.ldialog.R;


/**
 * Created by Sai on 15/8/15.
 */
@SuppressLint("HandlerLeak") public class SVProgressHUD {
    ...
    private SVProgressHUDShowTime mSVProgressHUDShowTime;
    ...
    public enum SVProgressHUDShowTime{
        OneSecond, // 1秒
        OneAndHalfSecond, // 1.5秒
        TwoSecond, // 2秒
        ThirdSecond // 3秒
    ...
    public static void showInfoWithStatus(Context context,String string,SVProgressHUDShowTime mSVProgressHUDShowTime) {
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
        getInstance(context).mSharedView.showInfoWithStatus(string);
        getInstance(context).svShow();
        getInstance(context).scheduleDismiss(mSVProgressHUDShowTime);
    }

    public static void showInfoWithStatus(Context context,String string, SVProgressHUDMaskType maskType,SVProgressHUDShowTime mSVProgressHUDShowTime) {
        getInstance(context).setMaskType(maskType);
        getInstance(context).mSharedView.showInfoWithStatus(string);
        getInstance(context).svShow();
        getInstance(context).scheduleDismiss(mSVProgressHUDShowTime);
    ...
    public static void showSuccessWithStatus(Context context,String string,SVProgressHUDShowTime mSVProgressHUDShowTime) {
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
    ...
    public static void showSuccessWithStatus(Context context,String string, SVProgressHUDMaskType maskType,SVProgressHUDShowTime mSVProgressHUDShowTime) {
        getInstance(context).setMaskType(maskType);
        getInstance(context).mSharedView.showSuccessWithStatus(string);
        getInstance(context).svShow();
        getInstance(context).scheduleDismiss(mSVProgressHUDShowTime);
    ...
    public static void showErrorWithStatus(Context context,String string,SVProgressHUDShowTime mSVProgressHUDShowTime) {
        getInstance(context).setMaskType(SVProgressHUDMaskType.Black);
    ...
    public static void showErrorWithStatus(Context context,String string, SVProgressHUDMaskType maskType,SVProgressHUDShowTime mSVProgressHUDShowTime) {
        getInstance(context).setMaskType(maskType);
        getInstance(context).mSharedView.showErrorWithStatus(string);
        getInstance(context).svShow();
        getInstance(context).scheduleDismiss(mSVProgressHUDShowTime);
    ...
    private void scheduleDismiss(SVProgressHUDShowTime svProgressHUDShowTime) {
        mHandler.removeCallbacksAndMessages(null);
        mSVProgressHUDShowTime = svProgressHUDShowTime ;
        switch(mSVProgressHUDShowTime){
            case OneSecond:
